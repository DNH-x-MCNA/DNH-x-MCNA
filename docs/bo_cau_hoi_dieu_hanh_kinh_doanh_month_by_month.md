...
3. **C03** — Lũy kế YTD thực hiện so kế hoạch và cùng kỳ năm trước thế nào; cần bình quân bao nhiêu mỗi tháng còn lại để đạt kế hoạch năm? — [SQL: S02](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
8. **C08** — Những tháng có tính mùa vụ cao/thấp nhất theo kênh và nhóm sản phẩm là tháng nào; tháng hiện tại lệch mô hình mùa vụ bao nhiêu? — [SQL: S06](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
11. **C11** — Doanh thu đang phụ thuộc vào top 10 khách hàng, top 10 sản phẩm và top 3 miền/vùng ở mức nào; xu hướng tập trung tăng hay giảm? — [SQL: S08](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
17. **C17** — Tỷ lệ hàng trả/điều chỉnh trên doanh thu theo tháng và kênh là bao nhiêu; nơi nào vượt ngưỡng? — [SQL: S09](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
22. **C22** — Đơn vị nào tăng trưởng liên tục 3/6 tháng; đơn vị nào giảm liên tục 3/6 tháng? — [SQL: S14](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
23. **C23** — Địa bàn nào có quy mô lớn nhưng tăng trưởng thấp; địa bàn nào quy mô nhỏ nhưng đang tăng nhanh? — [SQL: S14](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
24. **C24** — Tỉnh/vùng nào có độ phủ khách hàng thấp so với các địa bàn tương đồng; cơ hội trắng nằm ở đâu? — [SQL: S14](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
32. **C32** — Top khách hàng tăng/giảm mạnh nhất từng tháng là ai; thay đổi đó ảnh hưởng bao nhiêu đến toàn công ty? — [SQL: S20](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
36. **C36** — SKU nào có độ phủ khách hàng tăng nhưng doanh thu/khách giảm, hoặc doanh thu tăng nhưng độ phủ co lại? — [SQL: S23](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
44. **C44** — Hợp đồng ETC nào thực hiện chậm, còn giá trị lớn chưa giải ngân, sắp hết hạn hoặc phát sinh công nợ quá hạn? — [SQL: S29](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
47. **C47** — Cá nhân/đội nào dưới 80% liên tiếp 3 tháng hoặc biến động mạnh; khoảng hụt doanh thu là bao nhiêu? — [SQL: S31](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
51. **C51** — Ba rủi ro lớn nhất khiến không đạt kế hoạch là gì; mỗi rủi ro ảnh hưởng ước tính bao nhiêu tiền? — [SQL: S35](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
5. **M05** — Vùng nào dưới 80% kế hoạch liên tiếp; tổng hụt doanh thu tích lũy là bao nhiêu? — [SQL: S43](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
10. **M10** — Tỉnh/chi nhánh/NPP nào đang kéo giảm kết quả và cần ưu tiên can thiệp? — [SQL: S14](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
13. **M13** — QLV nào có nhiều nhân viên dưới 80% nhất; phần hụt của đội tập trung ở ai? — [SQL: S31](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
14. **M14** — Đội nào có doanh thu cao nhưng phụ thuộc vào ít nhân viên hoặc ít khách hàng? — [SQL: S39](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
16. **M16** — Nhân viên nào giảm doanh số liên tiếp 3 tháng; giảm do mất khách, giảm tần suất hay giảm giá trị đơn? — [SQL: S39](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
17. **M17** — Nhân viên mới đạt ramp-up thế nào sau 1/2/3/6 tháng so với chuẩn cùng vai trò? — [SQL: S32](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
18. **M18** — Địa bàn trống, nhân viên nghỉ/chuyển vùng hoặc khách chưa gán người phụ trách ảnh hưởng bao nhiêu doanh thu? — [SQL: S17](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
19. **M19** — QLV nào có span of control quá lớn/nhỏ; quy mô đội có ảnh hưởng đến năng suất không? — [SQL: S32](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
23. **M23** — Số khách mới, tái kích hoạt, mua lại và ngừng mua của từng vùng; tỷ lệ giữ chân sau 3/6 tháng? — [SQL: S18](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
27. **M27** — Tỉnh/huyện nào có ít khách hoạt động, ít đơn hoặc doanh thu/khách thấp hơn chuẩn miền? — [SQL: S14](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
33. **M33** — SKU nào doanh thu giảm do ít khách mua, ít đơn, giảm lượng/đơn hay giảm giá bán? — [SQL: S21](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
36. **M36** — Tỷ lệ trả hàng, chiết khấu và hàng tặng trên doanh thu của từng vùng thay đổi ra sao? — [SQL: S09](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
42. **M42** — Hợp đồng/gói thầu nào có tỷ lệ thực hiện thấp, còn giá trị lớn hoặc sắp hết hiệu lực? — [SQL: S29](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
2. **V02** — Còn thiếu bao nhiêu để đạt 65/70%, 80%, 100% và 120%; mỗi ngày còn lại cần bán bao nhiêu? — [SQL: S43](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
8. **V08** — Tỉnh/địa bàn con nào đang dưới kế hoạch; phần hụt là bao nhiêu và TDV nào phụ trách? — [SQL: S43](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
10. **V10** — Hôm nay/tuần này cần ưu tiên khách hàng, sản phẩm và nhân viên nào để đóng gap lớn nhất? — [SQL: S48](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)

### B. Quản trị từng nhân viên

11. **V11** — Doanh số, target và % hoàn thành từng TDV theo tháng; xếp hạng và xu hướng 3/6 tháng? — [SQL: S39](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
13. **V13** — Ai giảm liên tiếp 2–3 tháng; nguyên nhân nằm ở khách mất, ít đơn, ít SKU hay giá trị đơn giảm? — [SQL: S39](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
15. **V15** — Ai mở nhiều khách mới nhưng tỷ lệ mua lại thấp; ai tái kích hoạt khách tốt nhất? — [SQL: S44](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
21. **V21** — Khách im lặng 30/60/90 ngày là ai; lần mua gần nhất, giá trị và sản phẩm thường mua là gì? — [SQL: S40](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
23. **V23** — Khách mua lại/tái kích hoạt là ai; doanh thu phục hồi so trước khi ngừng mua thế nào? — [SQL: S18](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
24. **V24** — Khách nào giảm tần suất mua, AOV hoặc số SKU/đơn so với 3 tháng trước? — [SQL: S44](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
26. **V26** — Khách nào mua ít hơn các khách tương đồng cùng tỉnh/phân khúc? — [SQL: S44](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
27. **V27** — Khách nào chưa gán TDV, sai mã, sai tỉnh/vùng hoặc không có tên trong DMS? — [SQL: S38](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
28. **V28** — Danh sách khách ưu tiên tuần này theo bốn mục tiêu: giữ khách lớn, tái kích hoạt, thu nợ và bán chéo? — [SQL: S48](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
32. **V32** — Cặp sản phẩm nào thường mua cùng; khách nào phù hợp bán combo nhưng chưa mua? — [SQL: S41](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
...
40. **V40** — Cuối tháng, những ngoại lệ nào chưa xử lý: target thiếu, khách chưa gán, đơn chưa hóa đơn, nợ xấu, hàng trả và dữ liệu chưa đồng bộ? — [SQL: S38](./bo_cau_hoi_dieu_hanh_kinh_doanh_sql_check.md)
