...
|---|---:|---|
| ĐẠT | 65 | Chốt đạt hoặc ghi khớp không điều kiện, và lần chấm diễn ra sau bản sửa gần nhất |
...
| CHỜ KIỂM | 26 | Có bản sửa sau lần chấm, hoặc đối chiếu lúc đó không đúng phạm vi — không cộng vào đạt |
| CHƯA ĐẠT | 29 | Đã test, không khớp, chưa có bản sửa |
| CHƯA TEST | 0 | Chưa có kết quả chạy |
| **Tổng** | **126** | |

- Đạt chắc chắn: **65/126 = 51.6%**. Nếu các dòng chờ chốt giới hạn và cần xác nhận đều được duyệt: 71/126 = 56.3%.
- Kế hoạch ghi 72/126. Bảy câu kế hoạch tính đạt nhưng sổ này chưa tính: **C42, M27** (ghi khớp trước ngày có bản sửa), **V17** (lúc chấm S38 chưa lọc được theo đội), **C39** (đối chiếu với S26 bản so kỳ chưa tròn), **V22** (test và sửa cùng ngày), **C11, M41** (khớp phần chính, còn giới hạn nguồn chờ duyệt).
...
| C47 | ĐẠT | Đối chiếu với S64 trước khi thêm TK (+5,11 tỷ MN) — retest |
| M05 | ĐẠT | Checker vừa thêm TK — chỉ retest nếu lúc chấm không theo phạm vi MB |
...
| C47 | C-Level | A | — | S64 | ĐẠT | Khớp dữ liệu |
...
| M05 | GĐ miền/kênh | A | — | S58 | ĐẠT | Khớp dữ liệu |
...
| M28 | GĐ miền/kênh | B | B | S38 | CHƯA ĐẠT | Không khớp dữ liệu, cần kiểm tra query |
...
| V03 | QLV | B | A | S03 | CHƯA ĐẠT | Chưa nhập target tháng 9, chưa thể kiểm chứng |
